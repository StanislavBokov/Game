...
const MainButton = ({selectedNumbers,selectedNumbers2, array,array2,setCountMatch,setVisibleModal}) => {  
    const handleSubmit = () => {
    ...
    return ( 
        <button disabled={selectedNumbers.length + selectedNumbers2.length === 9?false:true} className='main-btn' onClick={()=>handleSubmit()}>Показать результат</button>
